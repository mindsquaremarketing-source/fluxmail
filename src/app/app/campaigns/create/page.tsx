          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Link href="/app/campaigns/templates" className="block">
                <div className="flex flex-col items-center gap-3 p-8 rounded-xl border-2 border-gray-200 bg-white hover:border-blue-500 hover:bg-blue-50 transition-all relative">
