    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            onClick={() => step === 1 ? router.push('/app/campaigns') : setStep(1)}
          ...
          <h1 className="text-lg font-semibold text-gray-900">Create Campaign</h1>
        </div>
        <div className="flex items-center gap-2">
          <span className={`w-2.5 h-2.5 rounded-full ${step >= 1 ? 'bg-purple-600' : 'bg-gray-300'}`}></span>
          <span className={`w-2.5 h-2.5 rounded-full ${step >= 2 ? 'bg-purple-600' : 'bg-gray-300'}`}></span>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              >
                ...
                <span className={`text-sm font-medium ${method === 'ai' ? 'text-purple-700' : 'text-gray-700'}`}>
                  Generate with AI
                </span>
              ...
              >
                ...
                <span className={`text-sm font-medium ${method === 'template' ? 'text-purple-700' : 'text-gray-700'}`}>
                  Start from template
                </span>
          ...
          <div>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Tell Fluxmail AI more info about this campaign
              </label>
              <textarea
                value={prompt}
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                What should the campaign feature?
              </label>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
              ...
              <div className="mb-4">
                ...
                <div className="flex rounded-lg border border-gray-200 overflow-hidden w-fit">
                  ...
                  <button
                    onClick={() => setDiscountMethod('none')}
                    className={`px-4 py-2 text-sm font-medium transition-colors ${
                      discountMethod === 'none'
                        ? 'bg-gray-900 text-white'
                        : 'bg-white text-gray-600 hover:bg-gray-50'
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        className="flex-1 px-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                      <button
                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative w-32">
                      <input
                        ...
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent pr-8"
                      />
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        />
                      </div>
                      <div>
