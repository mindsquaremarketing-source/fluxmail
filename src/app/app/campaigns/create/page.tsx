...
export default function CreateCampaignPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        {/* Start with Template - AI generated */}
          ...
          <div className="bg-white rounded-2xl border-2 border-gray-200 p-6 hover:border-blue-500 hover:shadow-md transition-all cursor-pointer group">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">AI-generated templates based on your brand &amp; products</p>
                <div className="flex gap-4 mt-2">
                  <span className="text-xs text-gray-400">&#127912; Your brand</span>
                  <span className="text-xs text-gray-400">&#128717; Real products</span>
        ...
        {/* Generate with AI - custom prompt */}
